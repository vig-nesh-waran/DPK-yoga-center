            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-6 d-flex gap-2 justify-content-end">
                        <a className='icons' href="mailto:dpkyogadummymail.com"><FontAwesomeIcon icon={faEnvelope} className=' fs-5'/></a>
                        <a className='icons' href="#"><FontAwesomeIcon icon={faFacebook} className=' fs-5'/></a>
                        <a className='icons' href="#"><FontAwesomeIcon icon={faInstagram} className=' fs-5'/></a>
                        <a className='icons' href="#"><FontAwesomeIcon icon={faGoogle} className=' fs-5'/></a>
                        <a className='icons' href="#"><FontAwesomeIcon icon={faTwitter} className=' fs-5'/></a>
                    </div>
                </div>
                <div className="row">
